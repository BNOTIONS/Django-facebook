...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.birthday'
        db.add_column('django_facebook_facebookuser', 'birthday',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.birthday'
        db.delete_column('django_facebook_facebookuser', 'birthday')
